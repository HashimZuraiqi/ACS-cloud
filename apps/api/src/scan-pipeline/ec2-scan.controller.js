...
exports.startEC2Scan = async (req, res) => {
    ...
    try {
        ...
        if (instanceId) {
            ...
            const rawConfig = await ec2ScannerAgent.scanInstance(instanceId);
            const analysis = await ec2ComplianceReasoner.analyze(rawConfig);
            ...
            const allConfigs = await ec2ScannerAgent.scanAllInstances();
